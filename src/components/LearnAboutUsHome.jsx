...
function LearnAboutUsHome() {
    ...
    return (
        <Center animation='fade-out 1s ease-in-out' bgImage="url('Assets/LearnAboutUsHomeBg.svg')" bgPosition='center' bgRepeat='no-repeat' overflow='hidden' p='100px 3%' bgSize={{base:'300%', lg:'initial'}}>
            <Center flexDirection={{base:'column', lg:'row'}} w='90%' maxW='1300px' >
                <Flex direction='column' w={{base:'75%', lg:'50%'}} align={{base:'center', lg:'flex-start'}} textAlign={{base:'center', lg:'initial'}}>
                    <Heading fontSize='50px' color='#35b8be' style={{wordSpacing:'-5px', wordWrap:'normal'}} w={{base:'100%', md:'400px'}}>The home of fresh products</Heading>
                ...
                <Image src='Assets/LearnAboutUsHomeImage.png' width={{base:'75%',lg:'40%'}} pt='50px' />
            </Center>
        </Center>
    )
}

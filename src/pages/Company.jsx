    ...
    return (
        <>
            ...
            <Center animation='fade-out 1s ease-in-out'>
                <Center flexDirection={{ base: 'column', lg: 'row' }} w='90%' maxW='1300px' p='100px 3%'>
                    ...
                    <Image src='Assets/CompanyImage1.png' w={{ base: '75%', lg: '40%' }} pt='50px' />
                </Center>
            </Center>
            ...
            <Center position='relative' bgImage='Assets/OrderNowHomeImage1.png' h='500px' bgRepeat='no-repeat' bgSize='2000px 1200px' p='100px 3%'>
                ...
                <SimpleGrid gap={{base:'50px', sm:'100px'}} zIndex='10' columns={{base:'2', lg:'4'}}>
                    {
                        menuItemsCountArray.map((item, index) => {
                            return (
                                <Center key={index} flexDirection='column' color='white' gap={{base:'5px', md:'20px'}}>

...
function Footer() {
    return (
        <Flex justify='center' pos='relative' bgColor='#35b7be12' h={{base:'700px', lg:'600px'}} p='0 3%'>
            ...
            <Flex direction={{base:'column', lg:'row'}} maxW='1200px' w='100%' pl='3%' mt='150px'  mb='60px' justify='space-between'>
                <Flex direction='column' gap='20px' w='350px'>
                ...
                <Flex direction='row' gap='80px' color = 'gray.600'>

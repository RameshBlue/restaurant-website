...
function ContactHome() {
    ...
    return (
        <Center bgImage="url('Assets/LearnAboutUsHomeBg.svg')" bgPosition='50% 50%' bgRepeat='no-repeat' overflow='hidden' p='100px 3%' bgSize={{ base: '300%', lg: 'initial' }}>
            <Center flexDirection={{ base: 'column', lg: 'row' }} maxW='1200px' >
                <Flex direction='column' w= '100%' p='30px' align={{ base: 'center', lg: 'flex-start' }} textAlign={{ base: 'center', lg: 'initial' }}>
                    <Heading fontSize='50px' color='#35b8be' style={{ wordSpacing: '-5px' }}>Call our store and takeaway when it suits you best.</Heading>
